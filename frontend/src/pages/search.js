            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ul
                        ...
                        {records?.map(record => (
                            <Link key={record.imdbId} href={`/record/${record.imdbId}`}>
                    ...
                    {total > perPage && <nav className="flex items-center justify-between px-4 sm:px-0 mt-4">
                        <div className="-mt-px flex w-0 flex-1">
                            <button
                                ...
                                <ArrowLongLeftIcon
                                    className={`mr-3 h-5 w-5 text-gray-400 ${!prevPageUrl && 'text-gray-300'}`}
                                    aria-hidden="true"
                                />
                                Previous
                            </button>
                        </div>
                        <div className="hidden md:-mt-px md:flex text-sm font-medium text-gray-700">Page {currentPage}/{lastPage}</div>
                        <div className="-mt-px flex w-0 flex-1 justify-end">
                            <button
                                ...
                                Next
                                <ArrowLongRightIcon
                                    className={`ml-3 h-5 w-5 text-gray-400 ${!nextPageUrl && 'text-gray-300'}`}
                                    aria-hidden="true"
                                />
                            </button>
                        </div>
